...
import { LightModeOutlined,DarkModeOutlined,Menu as MenuIcon, Search, SettingsOutlined, ArrowDropDownOutlined, LineWeightOutlined } from '@mui/icons-material';
      ...
      <FlexBetween gap='1.5rem'>
        <IconButton onClick={()=> dispatch(setMode())}>
          {theme.palette.mode === 'dark' ? (
            <DarkModeOutlined sx ={{font: '25px'}}/>
          ): (
            <LightModeOutlined sx ={{font: '25px'}}/>
          )}
          </IconButton>
          <IconButton>
              <SettingsOutlined sx ={{font: '25px'}} />
          </IconButton>
          <FlexBetween>
              ...
              <Box textAlign='left'>
                    ...
                    />
                        ...
                        <Menu anchorEl={anchorEl} open={isOpen} onClose={handleClose} anchorOrigin={{verticl: 'bottom', horizontal:'center'}}>
